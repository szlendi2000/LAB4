...
<div class="container mx-auto px-4 py-6">
    <h1 class="text-3xl font-bold mb-4">Witamy na stronie głównej!</h1>

    <nav class="mb-6">
        <a href="/" class="text-blue-500 hover:underline font-semibold">Główna</a> |
    ...
    <p class="text-gray-700">To jest przykładowa strona główna.</p>
</div>
@endsection
